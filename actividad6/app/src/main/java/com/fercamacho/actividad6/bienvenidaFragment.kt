...
class bienvenidaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btn_mascotas).setOnClickListener(){
            findNavController().navigate(R.id.misMascotasFragment)
        }

        view.findViewById<Button>(R.id.btn_planes).setOnClickListener(){
            val action = bienvenidaFragmentDirections.actionBienvenidaFragmentToPlanesFragment(
                view.findViewById<EditText>(R.id.textNombre).text.toString(),
                view.findViewById<EditText>(R.id.textCarrera).text.toString())
